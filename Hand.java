...
public class Hand implements HandInterface {
   ...
   /**
    * Evaluates a hand according to the rules of the dumb card game. Each card is
    * worth its displayed pip value (ace = 1, two = 2, etc.) in points with face
    * cards worth ten points. The value of a hand is equal to the summation of the
    * points of all the cards held in the hand.
    */
